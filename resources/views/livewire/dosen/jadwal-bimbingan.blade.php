<div>  
    ...
    <div class="card">
        <h5 class="card-header">Jadwal Bimbingan Saya</h5>
        <div class="table-responsive text-nowrap">
            <table class="table table-hover">
                ...
                <tbody class="table-border-bottom-0">
                    @forelse($jadwalBimbingan as $index => $jadwal)
                        <tr>
                            <td>{{ $jadwalBimbingan->firstItem() + $index }}</td>
                            <td>{{ $jadwal->hari }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-center py-4">Anda belum menambahkan jadwal bimbingan.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Jadwal Bimbingan Baru</h5>
                ...
                <form wire:submit.prevent="store">
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <select wire:model="hari" id="hari" class="form-select @error('hari') is-invalid @enderror">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input wire:model="jam_mulai" type="time" class="form-control @error('jam_mulai') is-invalid @enderror" id="jam_mulai">
                                @error('jam_mulai')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="jam_selesai" class="form-label">Jam Selesai</label>
                                <input wire:model="jam_selesai" type="time" class="form-control @error('jam_selesai') is-invalid @enderror" id="jam_selesai">
                                @error('jam_selesai')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="kuota" class="form-label">Kuota Mahasiswa</label>
                            <input wire:model="kuota" type="number" class="form-control @error('kuota') is-invalid @enderror" id="kuota" min="1">
